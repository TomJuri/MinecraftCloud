...
public enum ConsoleColor {
  ...
  public static String toColoredString(char triggerChar, String input) {
  ...
  private static String convertRGBColors(char triggerChar, String input) {
  ...
  public static String stripColor(char triggerChar, String input) {
  ...
  private static String stripRGBColors(char triggerChar, String input) {
    var replacePattern = Pattern.compile(triggerChar + "#([\\da-fA-F]){6}");
    return replacePattern.matcher(input).replaceAll("");
  }

  public static ConsoleColor byChar(char index) {
  ...
  public static ConsoleColor lastColor(char triggerChar, String text) {
    text = text.trim();
